...
// Para agregar o almacenar elementos a Local Storage usamos: 
...
//Convertimos el objeto de Javascript a formato .JSON con JSON.stringify()
const productoString = JSON.stringify(producto); //JSON.stringify convierte un objeto Javascript en formato JSON
console.log(typeof productoString); //Comprobamos que el objeto ya sea un string para poder ser almacenado en local Storage
