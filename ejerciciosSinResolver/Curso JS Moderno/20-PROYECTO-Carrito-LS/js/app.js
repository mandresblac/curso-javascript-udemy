...
function cargarEventListeners() {
  ...
  document.addEventListener("DOMContentLoaded", () => {
    articulosCarrito = JSON.parse(localStorage.getItem("carrito")) || []; //En caso de que el usuario no halla agregado nada al carrito le agrega un arreglo vacio " || [] " para que no le marque null

    //Imprime lo que tenemos en local storage
    carritoHtml();
  });
